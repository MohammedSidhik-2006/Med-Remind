    ...
    <div className="auth-page">
      ...
      <div className="auth-graphic-side">
        ...
        <div className="auth-graphic-body">
          <h1 className="auth-graphic-headline">
            Smart <span>medication tracking</span> for peace of mind.
          </h1>
          <p className="auth-graphic-sub">
            Monitor your daily pill schedules, keep streaks, receive dynamic push reminders, and connect caregiver accounts in one premium, secure platform.
          </p>
        </div>
      ...
      <div className="auth-form-side">
        <div className="auth-container">
          ...
          <p className="auth-subtitle">Access your clinical dashboard and adherence logs</p>
          ...
          <div className="auth-form">
            ...
            <p className="auth-link">
              New user? <Link to="/register">Sign up</Link> | <Link to="/forgot-password">Forgot password?</Link>
            </p>
          </div>
        </div>
      </div>
